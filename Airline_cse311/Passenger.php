...
<ul class="list-group">
  <li class="list-group-item active"><center>Passenger Menu</center></li>
  <li class="list-group-item"> <a href="http://localhost/airline/registrition/registrition.php">Sign Up Passenger</a> </li>
  <li class="list-group-item"> <#">Login Passenger</a> </li>
  <li class="list-group-item"> <#">Ticket Buy</a> </li>
  <
</ul>
